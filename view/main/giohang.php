...
<?php 	$money=$money+$tt; }
	 ?>
				<?php if(isset($_SESSION['cart_product'])){echo '<td><button class="btn btn-danger"><a href="view/cart/cart_update.php?xoaall=xoaall" title="" >Xóa tất cả</a></button></td>	';}?><th></th><th></th>
			...
			<div class="col-2" class="sa">
				<a href="index.php?"><input class="btn btn-info pull-right nutmua" type="button" name="" value="TIẾP TỤC MUA HÀNG"></a>
			</div>
			<div class="col-2" class="sa">
				<a href="index.php?view=thanhtoan"><input class="btn  btn-success pull-right nutmua" type="submit" name="" value="THANH TOÁN"></a>
			</div>
			<?php }else{
