  ...
  <div class="col-md-offset-4 col-md-4 " id="box" > 
   ...
   <form class="form-horizontal" action="" method="post" id="login_form"> 
    <fieldset> 
     ...
     <div class="form-group"> 
      <div class="col-md-12"> 
        <hr><button class="btn btn-md btn-danger"> <a style="color: #333; text-decoration: none" href="index.php?view=dangky">Đăng ký</a></button>
       <button type="submit" name="login" class="btn btn-md btn-success pull-right">Đăng nhập </button> 
      </div> 
     </div> 
    </fieldset> 
   </form> 
