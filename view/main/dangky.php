  ...
  <div class="col-md-offset-4 col-md-4 nenbac" id="box" > 
   ...
   <form class="form-horizontal" action="" method="post" id="login_form"> 
    <fieldset> 
     ...
     <div class="form-group"> 
      <div class="col-md-12"> 
      <hr><button class="btn btn-md btn-danger"> <a style="color: #333; text-decoration: none" href="index.php?view=login">Đăng Nhập</a></button>
       <button type="submit" name="dangky" class="btn btn-md btn-success pull-right">Đăng Ký </button> 
      </div> 
     </div> 
    </fieldset> 
   </form> 
