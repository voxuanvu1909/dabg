<div class="container-fluid header">
	<div class="row ">
		<img href="index.php" class="logoimg" src="webroot\img\Min Shoes.gif">
	</div>
</div>
<div class="container-fluid menu" id="menu">
	<div class="row">
		<div class="col-md-5">
			<ul class=" menu-l">
			<li class="w"><a href="index.php" title="">Trang Chủ</a>
				<li class="w"><a href="index.php" title="">Danh Mục <i class="fa fa-angle-down"></i></a>
                    ...
                    while ($row=mysqli_fetch_array($rss)) { ?>	
						<li><a href="/dacs2/index.php?view=dksanpham&madm=<?php echo $row['MaDM'];?>&t=<?php echo $row['TenDM'] ?>" ><?php echo $row['TenDM'];?></a></li>
					<?php  } ?>
					</ul>
				</li>
				<!-- <li class="a2 w"></li> -->
				<li class="w"><a href="index.php" title="">Sản Phẩm <i class="fa fa-angle-down"></i></a>
                    ...
                    $rss=mysqli_query($conn,$dmsql);                 
                    while ($row=mysqli_fetch_array($rss)) { ?>
						<li><a href="/dacs2/index.php?view=dksanpham&mancc=<?php echo $row['MaNCC'];?>&t=<?php echo $row['TenNCC'] ?>" ><?php echo $row['TenNCC'];?></a></li>
					 <?php  } ?>
					</ul>
				</li>
				<!-- <li class="a2 w"></li> -->
				<li class="w"><a href="" title="">Thông Tin <i class="fa fa-angle-down"></i></a>
				<ul class="sub-menu">
					<li><a href="?view=hethong">Hệ Thống Cửa Hàng</a></li>
					<li><a href="?view=lienhe">Liên Hệ</a></li>
				</ul>
				</li>
			</ul>
		</div>
		<div class="col-3 ">
		<form action="index.php?view=timkiem" method="POST" accept-charset="utf-8" style="padding-right: 55px;">
				<div class="input-group tk">
	                <input class="form-control border-secondary py-2" style="width:165px;"name="search" type="search" placeholder="Search">
